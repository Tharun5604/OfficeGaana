...
// ── YOUR LOCAL IMAGES ──
const MY_IMAGES = [
  { src: '/images/gallery/1.jpg',  alt: 'Office Gaana 1'  },
  { src: '/images/gallery/2.jpg',  alt: 'Office Gaana 2'  },
  { src: '/images/gallery/4.jpg',  alt: 'Office Gaana 4'  },
  { src: '/images/gallery/5.jpg',  alt: 'Office Gaana 5'  },
  { src: '/images/gallery/6.jpg',  alt: 'Office Gaana 6'  },
  { src: '/images/gallery/7.jpg',  alt: 'Office Gaana 7'  },
  { src: '/images/gallery/8.jpg',  alt: 'Office Gaana 8'  },
  { src: '/images/gallery/9.jpg',  alt: 'Office Gaana 9'  },
  { src: '/images/gallery/10.jpg', alt: 'Office Gaana 10' },
  { src: '/images/gallery/11.jpg', alt: 'Office Gaana 11' },
  { src: '/images/gallery/12.jpg', alt: 'Office Gaana 12' },
];
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(el => {
    ...
    const vSx0 = isFinite(sx0) && sx0 > 0 ? sx0 : 1, vSy0 = isFinite(sy0) && sy0 > 0 ? sy0 : 1;
